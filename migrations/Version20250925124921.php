 ...
 */
final class Version20250925124921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE season_recipe (season_id INT NOT NULL, recipe_id INT NOT NULL, INDEX IDX_CCF34F854EC001D1 (season_id), INDEX IDX_CCF34F8559D8A214 (recipe_id), PRIMARY KEY(season_id, recipe_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
