 ...
 */
final class Version20250930172003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX unique_season_recipe ON season_recipe');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX unique_season_recipe ON season_recipe (recipe_id, season_id)');
    }
}
